...
def runGA(instance, max_time, random_seed):
    ...
    min_dist, route, trace = geneticAlgorithm(population=cityList, max_time = max_time, random_seed = random_seed, input_GA=input_GA, popSize=100, eliteSize=20, mutationRate=0.01, generations=500, input_xy_GA)
